...
- useBufferedWrite: default true
```
> threaded_io_test -s ReplicatedRootSource=test.root -t 1 -n 10 -o RNTupleParallelOutputer=test.rntpl
```
or
```
> threaded_io_test -s ReplicatedRootSource=test.root -t 1 -n 10 -o RNTupleParallelOutputer=test.rntpl:compressionAlgorithm=zstd
```
or
```
